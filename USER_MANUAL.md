...
**A.** 音声ファイルのストリーミング再生により、データ通信が発生します。

**目安:**
- 1つの観光地点あたり: 約3〜5MB
- 1ツアー全体: 約50〜100MB

**推奨:** Wi-Fi接続を使用するか、データ通信プランに余裕があることを確認してください。
...
💾 **データ通信**
- データ通信が発生するため、海外で使用する場合は国際ローミング料金にご注意ください
